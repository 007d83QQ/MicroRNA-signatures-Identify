...
fitness_function_data::fitness_function_data(int _parameters_count, float _lower_bound, float _upper_bound, int _encode_bits_count, int num_objectives, bool _want_bigger_fitness_value, interface_fitness *arg)
{
    init( _parameters_count, _lower_bound, _upper_bound, _encode_bits_count, num_objectives, _want_bigger_fitness_value, arg);
}
...
void fitness_function_data::init(int _parameters_count, float _lower_bound, float _upper_bound, int _encode_bits_count, int num_objectives, bool _want_bigger_fitness_value, interface_fitness *arg)
{
...
void fitness_function_data::evalute (individual *_individual)
{
    if(evalute_object==nullptr)
    {
        printf("A evaluted_object did not be setup!!");
        exit(0);
    }
    evalute_object->fitness_function(_individual);
}
